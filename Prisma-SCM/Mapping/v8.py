...
output_file = r"C:\Users\DELL\Desktop\output\updated_export_objects_addresses8.csv"
...
for index, address in enumerate(sorted(missing_addresses)):
    ...
    for addr in addresses:
        if addr not in known_addresses:  # Avoid adding existing addresses
            custom_entries.append({"Name": generate_custom_name(index), "Location": "", "Type": "", "Address": addr})
